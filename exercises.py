...
def apply_discount(dis, percentage):
    discount = (percentage * dis) / 100
    discounted = dis - discount
    return discounted
...
def convert_temperature(degree, type):
    if type == "C":
        ...
        print("Provide a valid temperature Unit")
    return temperature
